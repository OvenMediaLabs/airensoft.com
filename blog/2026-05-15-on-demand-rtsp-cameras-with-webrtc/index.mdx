...
- **API Storage** — stream configurations created via REST API persist across server restarts. Essential when integrating with a VMS.
...
If you are evaluating Enterprise for your deployment, reach out at [contact@ovenmedialabs.com](mailto:contact@ovenmedialabs.com) or learn more on the [OvenMediaEngine Enterprise page](/ome-enterprise).
