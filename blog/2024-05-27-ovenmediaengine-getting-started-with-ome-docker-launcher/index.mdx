...
The example used in the video guide is below: Please refer to [**Adaptive Bitrate Streaming (ABR)**](/docs/ome/transcoding#adaptive-bitrate-streaming-abr) in the OvenMediaEngine User Guide for detailed information on the function.
