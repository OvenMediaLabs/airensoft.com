...
For quick guidance, we opened all TCP ports 0–65535 when creating the EC2 Instance, but the default ports used by OvenMediaEngine are as follows. For more information, please refer to [**Ports used by default**](https://airensoft.gitbook.io/ovenmediaengine/getting-started#ports-used-by-default) in the Getting Started sub-item of the OvenMediaEngine User Guide.
...
For detailed steps, refer to the [**Getting Started with OME Docker Launcher**](https://airensoft.gitbook.io/ovenmediaengine/getting-started/getting-started-with-ome-docker-launcher) guide, accessible under the Getting Started menu in the OME User Guide.
...
If you would like to know how to set up and use protocols that OvenMediaEngine can ingest, please refer to the [**Live Source**](https://airensoft.gitbook.io/ovenmediaengine/live-source) subsection in the OvenMediaEngine User Guide.
...
When streaming through OvenMediaEngine, you may or may not have a certificate. Please refer to the information below. For more information, refer to the [**Streaming**](https://airensoft.gitbook.io/ovenmediaengine/streaming) section in the OvenMediaEngine User Guide.
...
OvenMediaEngine operates according to Server.xml. Therefore, you need to know how to modify Server.xml to use the various functions provided by OvenMediaEngine. For guides for each function, please refer to the [**OvenMediaEngine User Guide**](https://airensoft.gitbook.io/ovenmediaengine).
...
To apply TLS to your OvenMediaEngine you have a domain. If you get a domain, you can easily use a certificate at no cost using Let’s Encrypt. For more information, see [**TLS Encryption**](https://airensoft.gitbook.io/ovenmediaengine/configuration/tls-encryption), a subtopic of Configuration in the OvenMediaEngine User Guide.
...
The example used in the video guide is below: Please refer to [**Adaptive Bitrate Streaming (ABR)**](https://airensoft.gitbook.io/ovenmediaengine/transcoding#adaptive-bitrate-streaming-abr) in the OvenMediaEngine User Guide for detailed information on the function.
...
Please refer to [**REST API**](https://airensoft.gitbook.io/ovenmediaengine/rest-api) in the OvenMediaEngine User Guide. This guide explains Server.xml items in detail and includes examples.
...
Please refer to the [**REST API (v1)**](https://airensoft.gitbook.io/ovenmediaengine/rest-api/v1) section in the OvenMediaEngine User Guide. It is written in detail about API resources, action names, reactions, etc.
