...
image: ./1-3jKWsMPEelXBMh6J-JAJ0w@2x.png
...
[Open Broadcaster Software](https://obsproject.com/) *(OBS or OBS Studio)* is one of the most popular open-source live encoders globally, favored by creators and streamers alike. These encoders enable content to be streamed to a streaming server using various protocols. When using [OvenStudio LLHLS](https://aws.amazon.com/marketplace/pp/prodview-66xy6t4xk56xs) (now OvenMediaEngine Enterprise on AWS) as your streaming server, you can reduce the traditional streaming delay of around 10 seconds to less than 3 seconds, providing an interactive experience for your viewers.

In this guide, we’ll walk you through the process of using OBS to send media sources to [OvenStudio LLHLS](https://aws.amazon.com/marketplace/pp/prodview-66xy6t4xk56xs) (now OvenMediaEngine Enterprise on AWS).

## OvenStudio LLHLS?

[OvenStudio LLHLS](https://aws.amazon.com/marketplace/pp/prodview-66xy6t4xk56xs) (now OvenMediaEngine Enterprise on AWS) is a **Low-Latency Streaming Server** that operates in a Cloud environment, boasting exceptional performance and scalability. It supports a range of ingress protocols *(WebRTC, WHIP, SRT, RTMP, and more)*, allowing media sources received via these protocols to be streamed as **Low Latency HLS** *(LLHLS)* with a streaming delay of less than 3 seconds. If you want to broadcast various content with minimal delay, [OvenStudio LLHLS](https://aws.amazon.com/marketplace/pp/prodview-66xy6t4xk56xs) (now OvenMediaEngine Enterprise on AWS) is your solution.

## Sending Media Sources to OvenStudio LLHLS

The process of sending media sources to [OvenStudio LLHLS](https://aws.amazon.com/marketplace/pp/prodview-66xy6t4xk56xs) (now OvenMediaEngine Enterprise on AWS) using OBS is straightforward and can be summarized in the following steps:
...
[OvenStudio LLHLS](https://aws.amazon.com/marketplace/pp/prodview-66xy6t4xk56xs) (now OvenMediaEngine Enterprise on AWS) provides easy scalability and delivers reliable low-latency streaming. It can be employed in various interactive content services, including game streaming, sports streaming, entertainment events, online classes, video conferencing, and more —* *[***What you can do with OvenStudio LLHLS***](/blog/what-you-can-do-with-ovenstudio-llhls).

The technological advancements and flexibility offered by [OvenStudio LLHLS](https://aws.amazon.com/marketplace/pp/prodview-66xy6t4xk56xs) (now OvenMediaEngine Enterprise on AWS) present content creators and streamers with opportunities to utilize streaming in diverse ways, enhancing interactions with viewers. Enjoy a superior streaming experience with [OvenStudio LLHLS](https://aws.amazon.com/marketplace/pp/prodview-66xy6t4xk56xs) (now OvenMediaEngine Enterprise on AWS)!
