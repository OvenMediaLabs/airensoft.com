...
![](./1--vxTC340-AZZOe_G6USjRQ.png)

We carried out several tests to perform the Sub-Second Latency Streaming concept of OvenMediaEngine in a better way. First, we announced each test result that used [OBS](https://obsproject.com/) and [OvenLiveKit](https://airensoft.com/olk) as live encoders last June through [AirenSoft’s Twitter](https://twitter.com/AirenSoft). Then, we executed the update of OvenLiveKit, OvenMediaEngine, and OvenPlayer after collecting the weak points found from the tests.
