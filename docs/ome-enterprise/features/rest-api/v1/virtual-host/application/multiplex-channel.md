...
Using Multiplex Channel, you can combine multiple internal streams into one ABR stream, or duplicate the stream and send it to another application. Multiplex Channel can be controlled by API or file. And the body of the API all has the same structure as the mux file of `MultiplexChannel`.
