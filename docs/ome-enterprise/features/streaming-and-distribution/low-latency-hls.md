...
Pallycon is no longer supported by the Open Source project and is only supported in the [Enterprise](../../pre-built-package-installation/getting-started/getting-started-with-linux.md) version. For more information, see this [article](https://github.com/AirenSoft/OvenMediaEngine/discussions/1634).
