...
<figure><picture><source srcset="../../images/multichannel_Edit.png" media="(prefers-color-scheme: dark)" /><img src="../../images/image-9.png" alt="" /></picture><figcaption></figcaption></figure>

## Configuration

To use this feature, enable the Multiplex Provider in `Server.xml`.
...
[multiplex-channel.md](../rest-api/v1/virtual-host/application/multiplex-channel.md)
