...
* **Repo**: [https://github.com/openssl/openssl](https://github.com/openssl/openssl)
* **License**: Apache-2.0 license ([https://github.com/openssl/openssl/blob/master/LICENSE.txt](https://github.com/openssl/openssl/blob/master/LICENSE.txt))

### SRTP (libsrtp) | 2.4.2

Used to encrypt and authenticate RTP packets as SRTP in WebRTC and related workflows.

* **Repo**: [https://github.com/cisco/libsrtp](https://github.com/cisco/libsrtp)
* **License**: Cisco BSD-like license ([https://github.com/cisco/libsrtp/blob/main/LICENSE](https://github.com/cisco/libsrtp/blob/main/LICENSE))

### SRT | 1.5.2

Used for ingest and publish over the SRT protocol.

* **Repo**: [https://github.com/Haivision/srt](https://github.com/Haivision/srt)
* **License**: MPL-2.0 license ([https://github.com/Haivision/srt/blob/master/LICENSE](https://github.com/Haivision/srt/blob/master/LICENSE))
...
* **License**: BSD-3-Clause license ([https://opus-codec.org/license](https://opus-codec.org/license))

### VPX (libvpx) | 1.11.0

Used for VP8 video encoding and decoding, primarily for WebRTC and real-time transcoding.

* **Repo**: [https://chromium.googlesource.com/webm/libvpx](https://chromium.googlesource.com/webm/libvpx)
* **License**: BSD 3-Clause license ([https://chromium.googlesource.com/webm/libvpx/+/refs/tags/v1.11.0/LICENSE](https://chromium.googlesource.com/webm/libvpx/+/refs/tags/v1.11.0/LICENSE))

### FDK-AAC | 2.0.2

Used for AAC audio encoding, including LC and HE profiles, for OTT streaming such as HLS, DASH, and RTMP.

* **Repo**: [https://github.com/mstorsjo/fdk-aac](https://github.com/mstorsjo/fdk-aac)
* **License**: Fraunhofer FDK AAC license ([https://android.googlesource.com/platform/external/aac/+/master/NOTICE](https://android.googlesource.com/platform/external/aac/+/master/NOTICE))
...
* **License**: LGPL-2.1-or-later license ([https://github.com/FFmpeg/FFmpeg/blob/master/LICENSE.md](https://github.com/FFmpeg/FFmpeg/blob/master/LICENSE.md))
...
* **Repo**: [https://github.com/netwide-assembler/nasm](https://github.com/netwide-assembler/nasm)
* **License**: BSD-2-Clause license ([https://github.com/netwide-assembler/nasm/blob/master/LICENSE](https://github.com/netwide-assembler/nasm/blob/master/LICENSE))

### PCRE2 | 10.39

Used to provide high-performance regular expression processing.

* **Repo**: [https://github.com/PCRE2Project/pcre2](https://github.com/PCRE2Project/pcre2)
* **License**: BSD-3-Clause license ([https://github.com/PCRE2Project/pcre2/blob/main/LICENCE.md](https://github.com/PCRE2Project/pcre2/blob/main/LICENCE.md))
...
* **Repo**: [https://github.com/cisco/openh264](https://github.com/cisco/openh264)
* **License**: BSD-2-Clause license ([https://github.com/cisco/openh264/blob/master/LICENSE](https://github.com/cisco/openh264/blob/master/LICENSE))

### Hiredis | 1.0.2

Used in OriginMapStore as a client library for integrating with Redis.

* **Repo**: [https://github.com/redis/hiredis](https://github.com/redis/hiredis)
* **License**: BSD-3-Clause license ([https://github.com/redis/hiredis/blob/master/COPYING](https://github.com/redis/hiredis/blob/master/COPYING))

### WEBP (libwebp) | 1.5.0

Used to encode thumbnail images in the WebP format.

* **Repo**: [https://chromium.googlesource.com/webm/libwebp](https://chromium.googlesource.com/webm/libwebp)
* **License**: BSD 3-Clause license ([https://chromium.googlesource.com/webm/libwebp/+/refs/tags/v1.5.0/COPYING](https://chromium.googlesource.com/webm/libwebp/+/refs/tags/v1.5.0/COPYING))
...
* **License**: MIT license ([https://github.com/gabime/spdlog/blob/v1.x/LICENSE](https://github.com/gabime/spdlog/blob/v1.x/LICENSE))

### JsonCpp | 1.9.3

Used for JSON parsing and generation.

* **Repo**: [https://github.com/open-source-parsers/jsoncpp](https://github.com/open-source-parsers/jsoncpp)
* **License**: MIT license ([https://github.com/open-source-parsers/jsoncpp/blob/master/LICENSE](https://github.com/open-source-parsers/jsoncpp/blob/master/LICENSE))

### pugixml | 1.9

Used for XML parsing and generation.

* **Repo**: [https://github.com/zeux/pugixml](https://github.com/zeux/pugixml)
* **License**: MIT license ([https://github.com/zeux/pugixml/blob/master/LICENSE.md](https://github.com/zeux/pugixml/blob/master/LICENSE.md))
