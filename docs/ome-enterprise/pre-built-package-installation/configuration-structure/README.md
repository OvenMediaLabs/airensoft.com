            ...
            <WebRTC>
                ...
                <IceCandidates>
                    ...
                    <!-- 
                        ...
                        For detailed information, refer https://ovenmedialabs.com/docs/ome/streaming/webrtc-publishing#webrtc-over-tcp
                    -->
...
| `WebRTC`       | Port for WebRTC. If you want more information on the WebRTC port, see the [WebRTC Ingest](../../features/live-source/webrtc-whip.md) and [WebRTC Streaming](../../features/streaming-and-distribution/webrtc-streaming.md) chapters.                                 |
| `OVT`          | <p>OVT port for an origin server.</p><p>OVT is a protocol defined by OvenMediaEngine for Origin-Edge communication. For more information about Origin-Edge, see the <a href="../../features/high-availability/clustering.md">Origin-Edge Clustering</a> chapter.</p> |
...
To run the Edge server, Origin creates application and stream if there isn't those when user request. For more learn about Origin-Edge, see the [Live Source](../../features/live-source/) chapter.
...
If you want to get more information about the `<Providers>`, please refer to the [Live Source](../../features/live-source/) chapter.
...
<Server version="8">
    ...
    <VirtualHosts>
        ...
        <VirtualHost>
            ...
            <!--
                Refer to https://ovenmedialabs.com/docs/ome/access-control/signedpolicy
            -->
            <!--
            <SignedPolicy>
...
Please note that future updates will enable you to control all features and settings of OvenMediaEngine through the Web Console within OvenMediaEngine Enterprise. Please look forward to future updates.
