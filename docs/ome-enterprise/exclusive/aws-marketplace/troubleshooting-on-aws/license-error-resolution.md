...
4. Run a basic streaming test by following the "[Post-Setup Verification for OvenMediaEngine Enterprise](../getting-started-on-aws/#post-setup-verification-for-ovenmediaengine-enterprise)" procedure.
