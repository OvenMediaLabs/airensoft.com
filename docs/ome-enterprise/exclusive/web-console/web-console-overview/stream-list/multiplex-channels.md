...
Multiplex Channel feature within OvenMediaEngine Enterprise to combine multiple ingressing streams into one to form an [Adaptive Bitrate Streaming _(_&#x41;BR)](../../web-console-settings/abr-and-transcoding-settings.md#adaptive-bitrate-streaming-abr) or to duplicate an external stream and send it to another Application.
...
Detailed Guide:  [https://docs.ovenmediaengine.com/live-source/multiplex-channel#configuration](https://docs.ovenmediaengine.com/live-source/multiplex-channel#configuration)
