...
* Added a new `HLS Publisher`, now officially supporting legacy HLS version 3 based on TS Containers (existing DASH, LLDASH, and Legacy HLS are completely deprecated): [/docs/ome/streaming/hls](/docs/ome/streaming/hls).
* Added concludeHlsLive action API: [/docs/ome/rest-api/v1/virtualhost/application/stream/conclude-hls-live](/docs/ome/rest-api/v1/virtualhost/application/stream/conclude-hls-live).
