...
* Added a new `HLS Publisher`, now officially supporting legacy HLS version 3 based on TS Containers (existing DASH, LLDASH, and Legacy HLS are completely deprecated): [https://airensoft.gitbook.io/ovenmediaengine/v/dev/streaming/hls](https://airensoft.gitbook.io/ovenmediaengine/v/dev/streaming/hls).
* Added concludeHlsLive action API: [https://airensoft.gitbook.io/ovenmediaengine/v/dev/rest-api/v1/virtualhost/application/stream/conclude-hls-live](https://airensoft.gitbook.io/ovenmediaengine/v/dev/rest-api/v1/virtualhost/application/stream/conclude-hls-live).
