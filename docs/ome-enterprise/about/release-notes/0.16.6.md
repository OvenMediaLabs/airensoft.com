...
* Added a new `HLS Publisher`, now officially supporting legacy HLS version 3 based on TS Containers (existing DASH, LLDASH, and Legacy HLS are completely deprecated): [https://ovenmedia.com/docs/ome/streaming/hls](https://ovenmedia.com/docs/ome/streaming/hls).
* Added concludeHlsLive action API: [https://ovenmedia.com/docs/ome/rest-api/v1/virtualhost/application/stream/conclude-hls-live](https://ovenmedia.com/docs/ome/rest-api/v1/virtualhost/application/stream/conclude-hls-live).
