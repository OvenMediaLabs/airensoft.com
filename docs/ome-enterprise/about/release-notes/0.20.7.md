...
* Fixed an issue where all-caps acronyms (e.g., `HTTP2`, `LLHLS`) were incorrectly formatted in camelCase during JSON serialization. Please refer to the table below.

  | No. | Method/Endpoint | Old key | New key |
  |-----|-----------------|---------|---------|
  | 1 | `GET /v1/vhosts/default` | `ignoreRtcpSRTimestamp` | `ignoreRtcpSrTimestamp` |
  | 2 | `GET /v1/vhosts/default/apps/app/outputProfiles/qa_profile` | `sAR` | `sar` |
  | 3 | `GET /v1/vhosts/default/apps/app/outputProfiles/qa_profile` | `hLSChunklistPathDepth` | `hlsChunklistPathDepth` |
  | 4 | `GET /v1/vhosts/default/apps/app` | `sTT` | `stt` |
  | 5 | `GET /v1/vhosts/default/apps/app` | `hLSID3v2` | `hlsId3v2` |
  | 6 | `GET /v1/vhosts/default/apps/app` | `fIRInterval` | `firInterval` |
  | 7 | `GET /v1/vhosts/default/apps/app` | `dVR` | `dvr` |
  | 8 | `GET /v1/vhosts/default/apps/app` | `dRM` | `drm` |
  | 9 | `GET /v1/vhosts/default/apps/app` | `mPEGTSPush` | `mpegtsPush` |
