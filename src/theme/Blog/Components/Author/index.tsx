...
export default function BlogAuthor({
  ...
  // Don't wrap the name in a mailto: link — readers don't click those.
  // Email is rendered as plain text below the title instead.
  const link = page?.permalink || url || undefined;
    ...
    <div
      ...
      {(name || title) && (
        <div className={clsx('avatar__intro', styles.authorDetails)}>
          ...
          {!!email && (
            <small className={styles.authorEmail} translate="no">
              {email}
            </small>
          )}
