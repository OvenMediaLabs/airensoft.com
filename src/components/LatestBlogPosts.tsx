/**
 * "From the Blog" section used on marketing pages (homepage, /ome,
 * /ome-enterprise, /latency).
 *
 * Renders the three most recent blog posts as a static card grid at
 * build time. Data comes from src/data/blog-index.json (generated by
 * scripts/build-blog-index.py from blog/<slug>/index.mdx frontmatter),
